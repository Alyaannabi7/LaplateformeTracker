...
public class MainView extends StackPane {
    ...
    public MainView() {
       ...
       Label alertSub = new Label("");
        ...
        // === LOGIN BUTTON ===
        Button loginButton = new Button("GRANTababanana ACCESS");
        ...
        message.setStyle("-fx-text-fill: #00f7ff; -fx-font-size: 13px;");
        ...
        loginButton.setOnAction(e -> {
            ...
            // Display result based on role returned
            switch (result) {
                case "student" -> message.setText("✅ Student access granted");
                case "prof"    -> message.setText("✅ Professor access granted");
                case "invalid" -> message.setText("❌ Invalid credentials");
                default        -> message.setText("⚠️ Server error");
            }
        });

        // === FORM BOX (bottom center) ===
